export default function Footer() {
  const footerImgs = [
    ...
    { src: "https://images.unsplash.com/photo-1593113598332-cd288d649433?w=600&q=80&auto=format&fit=crop", alt: "Volunteers helping community" },
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              <div
                ...
                style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(247,214,224,0.15)" }}
              >
        ...
        >
          ...
          {/* Responsive image grid:
              mobile  → 2 columns
              tablet  → 4 columns (all in one row)
          */}
            ...
            {footerImgs.map((img, i) => (
              ...
              >
                ...
                <div
                  ...
                  style={{ background: "rgba(30,14,48,0.35)", pointerEvents: "none" }}
                />
                {/* Caption bottom-left */}
                <span
                  className="absolute bottom-3 left-3 text-white font-medium"
                  style={{ fontSize: "11px", textShadow: "0 1px 4px rgba(0,0,0,0.6)" }}
                >
                  {img.alt}
                </span>
        ...
        >
          ...
          <span>
            Kampala, Uganda ·{" "}
            <a href="mailto:smco@mothers.com" style={{ color: "var(--accent-pink)", textDecoration: "none" }}>
              smco@mothers.com
            </a>
          </span>
        </div>
