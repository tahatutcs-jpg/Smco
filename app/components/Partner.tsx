...
const partnerTypes = [ { icon: "🏛️", title: "Government Agencies", desc: "Policy collaboration and resource mobilisation." }, { icon: "🌐", title: "NGOs & Charities", desc: "Joint programs and shared beneficiary networks." }, { icon: "🏢", title: "Corporate Companies", desc: "CSR partnerships and sponsorship opportunities." }, { icon: "👥", title: "Community Leaders", desc: "Grassroots outreach and beneficiary identification." }, { icon: "🌍", title: "International Organisations", desc: "Development funding and technical assistance." }, { icon: "⛪", title: "Religious Institutions", desc: "Faith-community networks for resource sharing." }, ];
