...
// Real photos for the strip
const stripPhotos = [
  { url: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=500&q=80", alt: "Mother and child" },
  { url: "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=500&q=80", alt: "Children learning" },
  { url: "https://images.unsplash.com/photo-1531983412531-1f49a365ffed?w=500&q=80", alt: "Community gathering" },
  { url: "https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?w=500&q=80", alt: "Healthcare" },
];
        ...
        {stripPhotos.map((p, i) => (
          ...
          >
            ...
            <div
              ...
              style={{ background: "rgba(30,14,48,0.45)" }}
            />
          </div>
        ))}
      </div>
