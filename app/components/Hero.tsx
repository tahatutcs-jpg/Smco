...
// Real Unsplash photos — African mothers, children, empowerment
const photos = [
  {
  ...
  {
    url: "https://images.unsplash.com/photo-1509099836639-18ba1795216d?w=400&q=80",
    alt: "Women empowerment",
    className: "col-span-1 row-span-1",
  },
  {
    url: "https://images.unsplash.com/photo-1531983412531-1f49a365ffed?w=400&q=80",
    alt: "Community gathering",
    className: "col-span-1 row-span-1",
  },
  {
    url: "https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?w=400&q=80",
    alt: "Hope and future",
    className: "col-span-1 row-span-1",
  },
];
          ...
          >
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-2xl" style={{ gridColumn: "3", gridRow: "2" }}>
                <img
                  src="https://images.unsplash.com/photo-1531983412531-1f49a365ffed?w=400&q=85"
                  alt="Community"
                  className="w-full h-full object-cover"
                  style={{ transition: "transform 0.6s ease" }}
                  onMouseEnter={e => (e.currentTarget.style.transform = "scale(1.06)")}
                ...
                <div
                  ...
                  style={{ background: "linear-gradient(to top, rgba(30,14,48,0.7) 0%, transparent 60%)" }}
                >
                  <span className="text-xs text-white font-medium">Community</span>
                </div>
              </div>
            </div>
