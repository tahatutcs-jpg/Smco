  ...
  return (
    <section id="about" className="max-w-7xl mx-auto px-6 lg:px-12 py-28">
      <div className="grid lg:grid-cols-2 gap-20 items-start">
        ...
        {/* Right — Photo + Values */}
        <div>
          {/* Fresh photo — women in a circle, community feel */}
          <div className="relative overflow-hidden rounded-2xl mb-8" style={{ height: "300px" }}>
            <img
              src="https://images.unsplash.com/photo-1541123437800-1bb1317badc2?w=900&q=85"
              alt="SMCO community — women gathered together"
              className="w-full h-full object-cover"
              style={{ objectPosition: "center 35%" }}
            />
            <div
              className="absolute inset-0"
              style={{ background: "linear-gradient(to top, rgba(61,26,94,0.6) 0%, transparent 50%)" }}
            />
