...
const WHATSAPP_NUMBER = "256744652458"; // Uganda number without +
  ...
  return (
    <section id="contact" style={{ background: "#fff" }}>
      ...
      <div className="relative overflow-hidden" style={{ height: "320px" }}>
        <img
          src="https://images.unsplash.com/photo-1620428268482-cf1851a36764?w=1600&q=85"
          alt="Community outreach — women gathering"
          className="w-full h-full object-cover"
          style={{ objectPosition: "center 40%" }}
        />
        <div
          className="absolute inset-0"
          style={{ background: "linear-gradient(to bottom, rgba(30,14,48,0.35) 0%, rgba(30,14,48,0.72) 100%)" }}
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <div className="flex items-center gap-3 mb-4">
            <span className="w-7 h-px" style={{ background: "rgba(247,214,224,0.5)" }} />
            <span className="text-xs font-semibold tracking-widest uppercase" style={{ color: "rgba(247,214,224,0.7)" }}>Reach Out</span>
            <span className="w-7 h-px" style={{ background: "rgba(247,214,224,0.5)" }} />
          </div>
          <h2
          ...
          <p className="text-white mt-3 max-w-md text-sm leading-6" style={{ color: "rgba(255,255,255,0.65)" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          <div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm" style={{ color: "rgba(255,255,255,0.75)" }}>Get a reply within hours — fastest way to reach us.</p>
              </div>
              <button
          ...
          {/* Right — form */}
          <div className="rounded-3xl p-10" style={{ boxShadow: "0 8px 48px rgba(192,68,106,0.1)", border: "1px solid rgba(192,68,106,0.08)", background: "#fff" }}>
            <h3 className="font-display text-2xl mb-1" style={{ color: "var(--near-black)" }}>Send a Message</h3>
            <p className="text-sm mb-6" style={{ color: "var(--muted)" }}>Fills your email client — your message goes directly to our inbox.</p>
